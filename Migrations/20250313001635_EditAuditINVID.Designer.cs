...
namespace EF_Project.Migrations
{
    ...
    [Migration("20250313001635_EditAuditINVID")]
    partial class EditAuditINVID
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EF_Project.Entities.Audit_Tracking", b =>
                {
                    ...
                    b.Property<int?>("From_Inv_To_Inv_Tracker_navTrs_ID")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("pull_order_navPullOrderId")
                        .HasColumnType("int");

                    b.Property<int?>("supply_order_navSupplyOrderID")
                        .HasColumnType("int");

                    b.HasKey("ID");

                    b.HasIndex("From_Inv_To_Inv_Tracker_navTrs_ID");

                    b.HasIndex("Taregt_Inv");

                    b.HasIndex("itemCode");

                    b.HasIndex("pull_order_navPullOrderId");

                    b.HasIndex("supply_order_navSupplyOrderID");
            ...
            modelBuilder.Entity("EF_Project.Entities.Audit_Tracking", b =>
                {
                    b.HasOne("EF_Project.Entities.From_Inv_to_Inv_Tracker", "From_Inv_To_Inv_Tracker_nav")
                        ...
                        .HasForeignKey("From_Inv_To_Inv_Tracker_navTrs_ID");
                    ...
                    b.HasOne("EF_Project.Entities.PullOrder", "pull_order_nav")
                        .WithMany("AuditTrackers")
                        .HasForeignKey("pull_order_navPullOrderId");

                    b.HasOne("EF_Project.Entities.SupplyOrder", "supply_order_nav")
                        .WithMany("AuditTrackers")
                        .HasForeignKey("supply_order_navSupplyOrderID");
